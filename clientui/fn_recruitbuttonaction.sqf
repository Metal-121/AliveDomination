...
// equippe the unit with ace gear
// if ((d_with_ace )&& (getUnitTrait "medic")) {_unit call d_fnc_acerefitai}
//Add Ace loadout Loaded by extendedEventhandler see description.ext
//[_unit] execVM "mtl_loadout.sqf";
