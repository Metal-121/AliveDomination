...
#ifndef __TT__
d_choppers = [
	["D_HR1",0,"d_chopper1",3001,"n_air","ColorWhite","1", localize "STR_DOM_MISSIONSTRING_7"],
	["D_HR2",2,"d_chopper2",3002,"n_air","ColorGreen","2","MEDEVAC"],
	["D_HR3",0,"d_chopper3",3003,"n_air","ColorWhite","3",localize "STR_DOM_MISSIONSTRING_7"],
	["D_HR4",1,"d_chopper4",3004,"n_air","ColorRed","W", localize "STR_DOM_MISSIONSTRING_10"],
	["D_HR5",2,"d_chopper5",3005,"n_air","ColorWhite","HKP9", localize "STR_DOM_MISSIONSTRING_11"],
	["D_HR6",2,"d_chopper6",3006,"n_air","ColorWhite","HKP9", localize "STR_DOM_MISSIONSTRING_11"],
	["D_HR7",2,"d_chopper7",3007,"n_plane","ColorBlue","Herc","Paradrop"],
	["D_HR8",2,"d_chopper8",3008,"n_air","ColorYellow","HKP9","AT"],
	["D_HR9",2,"d_chopper9",3009,"n_plane","ColorBlue","JAS","LGB"],
	["D_HR10",2,"d_chopper10",3010,"n_plane","ColorBlue","JAS","CAP"],
	["D_HR11",2,"d_chopper11",3011,"n_plane","ColorBlue","A10","CAS"]
];
#else
d_choppers_blufor = [
...
d_p_vecs = [
	...
	["D_MEDVEC1",100,"d_medvec_1","n_med","ColorGreen","M1",""],["D_MEDVEC2",101,"d_medvec_2","n_med","ColorGreen","M2",""],
	...
	["D_TR9",400,"d_truck9","n_support","ColorGreen","T1",""],["D_TR10",401,"d_truck10","n_support","ColorGreen","T2",""],["D_TR11",402,"d_truck11","n_support","ColorGreen","T3",""],["D_TR12",403,"d_truck12","n_support","ColorGreen","T4",""],["D_TR13",404,"d_truck13","n_support","ColorGreen","T5",""],["D_TR14",405,"d_truck14","n_support","ColorGreen","T6",""],["D_TR15",406,"d_truck15","n_support","ColorGreen","T7",""],["D_TR16",407,"d_truck16","n_support","ColorGreen","T8",""],["D_TR17",408,"d_truck17","n_support","ColorGreen","T9",""],["D_TR18",409,"d_truck18","n_support","ColorGreen","T10",""],["D_TR19",410,"d_truck19","n_support","ColorGreen","T11",""],["D_TR20",411,"d_truck20","n_support","ColorGreen","T12",""],["D_TR21",412,"d_truck21","b_hq","ColorBlue","C1","Cmdr"]
];
if (d_ifa3lite) then {
