...
if (isServer) then {
	...
	private _choppers = [
	[d_chopper_1,3001,true,600],
	[d_chopper_2,3002,true,1500],
	[d_chopper_3,3003,true,1500],
	[d_chopper_4,3004,false,600],
	[d_chopper_5,3005,true,600],
	[d_chopper_6,3006,true,600],
	[d_chopper_7,3007,false,600],
	[d_chopper_8,3008,false,600],
	[d_chopper_9,3009,false,600],
	[d_chopper_10,3010,false,600],
	[d_chopper_11,3011,false,600]
	] select {!isNil {_x # 0}};
	...
	[d_vec_med_1,100],[d_vec_med_2,101]
	,[d_vec_rep_1,200],[d_vec_rep_2,203],
	[d_vec_fuel_1,201],[d_vec_fuel_2,204],
	[d_vec_ammo_1,202],[d_vec_ammo_2,205],
	[d_vec_eng_1,300],[d_vec_eng_2,301],
	[d_vec_trans_1,400],[d_vec_trans_2,401],[d_vec_trans_3,402],[d_vec_trans_4,403],[d_vec_trans_5,404],[d_vec_trans_6,405],[d_vec_trans_7,406],[d_vec_trans_8,407],[d_vec_trans_9,408],[d_vec_trans_10,409],[d_vec_trans_11,410],[d_vec_trans_12,411],[d_vec_trans_13,412]
	] select {!isNil {_x # 0}};
	{
